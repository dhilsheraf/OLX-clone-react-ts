  ...
  return (
    ...
    <div className='flex p-4 bg-slate-100 shadow-sm'>
      ...
      <div className='flex border-2 border-spacing-1 w-68 p-2 border-black ml-5 bg-white'>
        ...
        <input type="text" name="" id="" placeholder='Location' className='ml-3 outline-none'/>
        <img src={arrow} alt="" className='w-8 h-7' />
      </div>
      <div className='flex h-12 ml-4 border-2 border-black bg-white'>
        <input onChange={(e)=>props.setSearch(e.target.value)} placeholder='Find Cars, Mobile phones and more' className='ml-3 w-160'/>
        <img src={search} alt="" />
      </div>
